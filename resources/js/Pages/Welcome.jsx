                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8">
                    <div className="flex justify-center">
                        <svg
                            ...
                            viewBox="0 0 512 512"
                            className="h-16 w-auto bg-gray-100 dark:bg-gray-900 fill-current text-red-500"
                        >
                    ...
                    <div className="mt-16">
                        <div className="text-center">
                            ...
                            <p className="mt-4 text-xl text-gray-600 dark:text-gray-400">
                                Embark on a turn-based adventure through
                                dangerous dungeons!
                            </p>
                            {auth.user ? (
                                <Link
                                ...
                                <div className="mt-8 flex justify-center space-x-4">
                                    ...
                                    <Link
                                        href={route("register")}
                                        className="inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-base font-medium rounded-md shadow-sm text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                    >
                                        Register
                                    </Link>
                                </div>
                        ...
                        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            <div className="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        Battle enemies with a strategic combat
                                        system featuring multiple skills and
                                        cooldowns. Choose when to attack, heal,
                                        or use special abilities to overcome
                            ...
                            <div className="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        Level up your character and choose which
                                        stats to improve. Will you increase your
                                        attack power, boost your defense, or
                                        enhance your healing abilities? Every 5
                                        levels, make a crucial decision that
                                        shapes your character's development.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        Face a variety of monsters with unique
                                        stats and abilities. From Giant Rats to
                                        Ancient Dragons, each enemy presents a
                                        different challenge that requires
                            ...
                            <div className="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                                <div>
                                    ...
                                    <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                        Compete with other players to reach the
                                        highest dungeon level. Your progress is
                                        tracked on the leaderboard, showcasing
                                        your character's name and greatest
                                        achievement. Can you climb to the top?
                                    </p>
                                </div>
                            </div>
                        </div>
