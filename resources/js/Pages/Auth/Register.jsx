...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div className="pt-6 flex flex-col items-center">
                <Link href="/">
                    <svg
                        ...
                        viewBox="0 0 512 512"
                        className="h-20 w-auto bg-gray-100 dark:bg-gray-900 fill-current text-red-500"
                    >
            ...
            <div className="sm:max-w-md mx-auto mt-8 px-6 py-4">
                    ...
                    <form onSubmit={submit}>
                        <div>
                            ...
                            <TextInput
                                ...
                                name="name"
                                value={data.name}
                                className="mt-1 block w-full bg-white/5 border-gray-700 text-gray-900 dark:text-white focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm"
                                autoComplete="name"
                                isFocused={true}
                                onChange={(e) =>
                ...
                <div className="flex justify-between mt-6 text-sm">
                    <Link
                        href="/"
                        className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                    >
                        ← Back to Home
                    </Link>
